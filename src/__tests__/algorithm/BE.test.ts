...
describe('BEAlgorithm Validation', () => {
  ...
  it('should return 4 if the length is incorrect', () => {
  ...
  it('should return 3 if the TIN does not match the pattern', () => {
  ...
  it('should return 3 if the TIN has an invalid date', () => {
  ...
  it('should return 1 if the TIN fails Belgium rules', () => {
  ...
  it('should return 3 for TIN that fails Belgium rule 3', () => {
